...
public class Ex06 {
	...
	public static void main(String[] args) {
		// 논리 연산자
		// and (&&) : 서로 다른 두 조건이 모두 참이면 결과가 참, 아니면 거짓 (순서도 중요함)
		// of (||) : 서로 다른 두 조건 중 하나라도 참이면 결과가 참, 아니면 거짓
		// not (!) : 하나의 조건이 참이면 거짓, 거짓이면 참. => 단항 연산
		
		int age = 25;
		int gender = 1;		// 홀수는 남성, 짝수는 여성
		
		boolean quest = age >= 20 && gender % 2 == 1;
		// 나이가 20 이상이고, 성별이 홀수이면 quest를 수행해야 합니다.
		...
		// 게시글을 삭제하기 위한 조건 : (1) 로그인 상태여야 하고, 게시글의 작성자와 동일계정이어야 한다.
		
		String s1 = "Hello, world !!";
		String s2 = null; // 없는 남자친구
...
//		System.out.println("s2의 길이 : " + s2.length());
		...
		// 첫번째 조건이 거짓이면 두번째 조건식은 아예 수행하지 않는다.
		...
		for(int i = 1; i < 10; i++) {				// 1에서 9까지의 정수에서
		...
		System.out.println("isAdlut : " + isAdult);
	}
}
