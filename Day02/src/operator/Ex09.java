...
public class Ex09 {
	public static void main(String[] args) {
		...
		if(flag == false) {					// 조건이 거짓이면
			System.err.println("불합격");		// 불합격을 출력
		}
		// if문은 조건에 따라서 서로 다른 코드를 실행하는 구문이다. ex) 어떤 행위를 할 것인가 ?
		// 삼항연산은 조건에 따라서 서로 다른 값을 결정하는 구문이다. ex) 어떤 값을 결정할 것인가 ?
		
//		아래 코드는 값을 결정할 수 없는 코드이기 때문에 실행할 수 없다 (잘못된 예시)
//		안 되는 예시 flag ? System.out.println("합격") : System.out.println("불합격");
	}
}
