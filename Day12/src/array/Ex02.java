...
public class Ex02 {
	public static void main(String[] args) {
		// 배열은 일반 변수가 여러 개 모여있다고 생각하면 사용하기 편하다.
...
//		int[] arr5 = new int[5] {1, 2, 3, 2, 1}; // 문법 틀림
		...
		arr4[0] = 11;	// 배열 이름에 []을 붙이고 안에 index를 적어준다.
		arr4[1] = 33;	// 배열을 구성하는 여러 멤버 요소 중 하나에 접근한다.
...
//		arr4[5] = -1;		// 여기선 문법적으로 문제는 안 되지만 출력하면 에러남.
		System.out.println("arr4 : " + Arrays.toString(arr4));
	}
}
