	...
	public static void main(String[] args) {
		...
		Wrapper Class는 객체에 대한 자료형이므로, 데이터 저장 및 기능이 포함되어 있다.
			...
			<primitive type>		<Wrapper Class>
				...
				double					Double
		 */
		// 같은 유형의 primitive <-> Wrapper Class 는 암묵적 형변환이 적용된다.
		int n1 = 10;
		Integer n2 = n1;
		n1 = n2;
		
		// primitive 사이에서 암묵적 형변환이 적용되는 관계라도 Wrapper Class끼리는 적용되지 않는다.
		byte by = 10;
		int n3 = 20;
		n3 = by;
...
//		n4 = by2;		 Wrapper Class끼리는 호환성이 없다.
		...
		n4 = by2.intValue();
		// by2에 담긴 값을 int 형태로 바꿔서 대답할 수 있도록 해주는 기능 (함수)
		System.out.println("int 자료형의 최소값 : " + Integer.MIN_VALUE);
		System.out.println("int 자료형의 최대값 : " + Integer.MAX_VALUE);
		
		System.out.println("문자열 1234를 정수형태로 바꾸기 : " + Integer.parseInt("1234"));
		String s = "1234";
