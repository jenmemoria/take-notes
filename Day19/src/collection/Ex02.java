...
public class Ex02 {
	public static void main(String[] args) {
		...
		// 따라서, 특정 자료형만 관리하는 컬렉션을 생성하기 위해 내부 자료형을 명시해야 한다.
		// GenericType을 지정하면 컬렉션 내부의 일반적인 자료형이 무엇인지 명시할 수 있다.
		...
		// list.add(E e)
		// E는 새성 시 제네릭 타입을 가리킨다.
		
		// 내부에 String 타입의 값만 저장할 수 있는 리스트
		ArrayList<String> list = new ArrayList<>();
		list.add("10");		// 정수 및 실수는 추가할 수 없고, String 타입의 데이터만 추가할 수 있다.
		list.add("11월 10일");
		list.add("한명이 안 왔엉...");
