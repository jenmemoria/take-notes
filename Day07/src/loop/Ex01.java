...
public class Ex01 {
	public static void main(String[] args) {
		...
		// 여기서 일정 횟수는 직접 지정할 수도 있고, 특정 배열 및 컬렉션 요소에 길이만큼
		// 다시 말해 변수의 개수만큼 반복하여 사용할 수도 있다.
		
		// 내부 요소가 여러개가 있고, 그 여러개의 요소만큼 반복 돌릴 수 있는 형태를
		// iterable 하다라고 표현한다.
		
		for (int i = 0; i < 5; i++) {	// int i라는 변수는 여기 중괄호 안에서만 유효하다.
...
//		local variable : 특정 지역에서만 유효한 변수
		...
		// 		해당 지역 내에서만 유효하다.
		//		{} 블력을 벗어나면 참조할 수 업고, 같은 이름의 새로운 변수를 생성할 수도 있다.
...
//		System.out.println("num2: " + num2);	num2 cannot be resolved to a variable, if가 종료되면서 num2도 소멸
