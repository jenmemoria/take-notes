...
public class Ex05 {
	public static void main(String[] args) throws IOException {
		...
		// catch : try에서 예외가 발생하면 지정한 타입의 예외를 받아서 처리한다.
		// 		   하나의 try에 여러 catch를 작성할 수도 있다.
		//		   이 때, 순서는 상세한 것부터 포괄적인 예외순으로 작성 해야한다.
		//		   맨 아래에 catch(Exception e)를 작성하면 모든 예외에 대한 처리가 있다.
		// finally : 예외 발생 여부에 상관없이 항상 실행되는 코드를 작성한다. 주로 마무리 코드를 작성한다.
		// throw : 임의로 예외 객체를 생성한 다음, 생성된 예외 객체를 catch에게 넘기는 용도로 사용한다.
