...
abstract class Test3{	// 추상 클래스. 객체화 할 수 없다.
	void function1() {	// 일반 메서드를 포함할 수 있다. (추상메서드도 포함할 수 있다.)
...
class Sub extends Test3{
	...
	// 2) 추상메서드를 오버라이딩해서, body를 만들어주면 더이상 추상메서드가 아니게 된다. (일반메서드가 된다.) ★
	// -> 2번을 쓰면 의무적으로 오버라이딩을 해야한다.
	// 보통 2번을 많이 쓴다.
	// 형식을 통일하기 위해 추상클래스 !
...
public class Ex03 {
	public static void main(String[] args) {
		...
		// 문법적으로는 객체 특성의 형태만 지정되어 있고, 구체적인 내용이 지정되지 않은 형식을 추상화라고 한다.
